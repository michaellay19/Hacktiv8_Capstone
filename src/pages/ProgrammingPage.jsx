...
function ProgrammingPage() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            dispatch({ type: NEWS_REDUCER_CASES.DONE_FETCHING_NEWS }); // Set loading menjadi false setelah fetching selesai
        };
        ...
        <main>
            ...
            <section className={styles.pageContainer}>
                ...
                <section className={styles.newsContainer}>
                    {newsReducer.loading ? ( // Tampilkan loading screen jika loading true
